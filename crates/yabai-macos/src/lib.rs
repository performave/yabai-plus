...
#[cfg(target_os = "macos")]
pub use display::{
    MacDisplay, active_displays, cursor_display_id, cursor_location, display_uuid, main_display_id,
...
pub use space::{
    ...
    space_is_native_fullscreen, space_uuid, spaces_for_display, spaces_for_window,
    switch_space_by_gesture, window_alpha, window_bounds, window_is_ordered_in, window_level,
